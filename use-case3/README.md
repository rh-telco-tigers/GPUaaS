...
oc apply -f use-case3/02-cohort-clusterqueues.yaml
oc apply -f use-case3/03-localqueues.yaml
```
...
```bash
oc apply -f use-case3/04-phase2-training-own.yaml
...
```bash
oc apply -f use-case3/05-phase3-training-borrow.yaml
oc get workloads -n gpuaas-cohort-demo -w
oc get clusterqueue t4-inferencing-queue t4-training-queue -o wide
```
...
```bash
oc delete -f use-case3/05-phase3-training-borrow.yaml --ignore-not-found
oc delete -f use-case3/04-phase2-training-own.yaml --ignore-not-found
oc delete -f use-case3/03-localqueues.yaml --ignore-not-found
oc delete -f use-case3/02-cohort-clusterqueues.yaml --ignore-not-found
